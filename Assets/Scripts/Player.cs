...
public class Player : MonoBehaviour
{
    ...
    // ============================================================
    // CONFIGURACIÓN - Cambiar estos valores para la comparativa
    // ============================================================
    private const int MAX_DEPTH = 4;        // Profundidad del árbol (entre 2 y 4)
    private const int HEURISTIC = 3;        // 1=H1, 2=H2, 3=H3, 4=H4
